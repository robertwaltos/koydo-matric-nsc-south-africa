...
export const metadata: Metadata = {
  title: "Pricing — Matric Nsc South Africa Premium",
  description: "Unlock unlimited Matric Nsc South Africa practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=matric-nsc-south-africa&cadence=annual`;
    ...
    <main className="min-h-screen px-4 py-12">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h1 className="mb-4 text-3xl font-bold text-zinc-900 dark:text-zinc-100">
          Matric Nsc South Africa Premium
        </h1>
